...
### Counts
Counts are optional and simply let you put a multiplier to your command and motion. We can see how these work in the examples below. But remember, the actual order of these power commands are **[OPERATION]>[NUMBER]>[MOTION]**.

# Deleting Words
Navigating to the beginning of a word in the editor and entering the command 'dw' will delete a word from the point the cursor is until the end of the word. _Note: This does not include final punctuation, such as period or comma after the world._
...
_Note: Remember, as stated above, the operational order is [OPERATOR][NUMBER][MOTION]._
...
# Undo'ing & Redo'ing
### The Undo Command
With all these commands, there's a good chance you might mess up once or twice. You can quickly undo a command with: 'u'. _Note that Vim has multiple levels of undo. I have custom set it for 500 levels._
...
:noh - clears the search result word highlight.
...
function hippopotamus() {<br>
    // insert 1 millions lines of code here.<br>
}
